"""Compare production v3.20 and proposal v3.23 through disclosed v14."""
...
from proposals.detector_v3_23 import detect as detector_v3_23
...
DISCLOSED_DATASETS = (
    ...
    *(f"sealed_holdout_v{version}.json" for version in range(4, 15)),
)
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    detectors = {"v3.20": detector_v3_20, "v3.23": detector_v3_23}
