"""Compare production v3.26 and candidate v3.27 on disclosed data through v16."""
...
from app.detection.detector_v3_27 import detect as detector_v3_27
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    detectors = {"v3.26": detector_v3_26, "v3.27": detector_v3_27}
