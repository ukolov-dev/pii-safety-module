"""Compare production v3.13 and isolated v3.18 on disclosed datasets."""
...
from proposals.detector_v3_18 import detect as detector_v3_18
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ...
        ("candidate_v3_18", detector_v3_18),
    )
