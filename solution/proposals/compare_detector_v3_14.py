"""Compare production v3.3 and model-ready v3.14 on disclosed datasets."""
...
from proposals.detector_v3_14 import detect as detector_v3_14
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ...
        ("candidate_v3_14", detector_v3_14),
    )
