"""Compare production v3.20 and isolated v3.22 on disclosed datasets."""
...
from proposals.detector_v3_22 import detect as detector_v3_22
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ...
        ("candidate_v3_22", detector_v3_22),
    )
