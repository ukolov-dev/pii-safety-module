"""Compare production v3.3 and isolated v3.12 on disclosed datasets."""
...
from proposals.detector_v3_12 import detect as detector_v3_12
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ...
        ("candidate_v3_12", detector_v3_12),
    )
