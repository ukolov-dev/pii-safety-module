"""Candidate v3: conservative, format-tolerant recognizers for Russian PII.

The candidate is intentionally isolated from :mod:`app.detection.detector` so it can
be compared with production before promotion.  The rules are based on field
