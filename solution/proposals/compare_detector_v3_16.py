"""Compare production v3.13 and isolated v3.16 on disclosed datasets."""
...
from proposals.detector_v3_16 import detect as detector_v3_16
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ...
        ("candidate_v3_16", detector_v3_16),
    )
