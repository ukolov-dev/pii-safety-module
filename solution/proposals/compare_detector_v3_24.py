"""Compare production v3.20 and isolated v3.24 on disclosed datasets."""
...
from app.detection.detector_v3_20 import detect as production_detect
from app.detection.models import DetectedEntity
from proposals.compare_detector_v3_6 import score
from proposals.detector_v3_24 import detect as detector_v3_24
...
DATASETS = (
    ...
    "sealed_holdout_v8.json",
    "sealed_holdout_v9.json",
    "sealed_holdout_v10.json",
    "sealed_holdout_v11.json",
    "sealed_holdout_v12.json",
    "sealed_holdout_v13.json",
    "sealed_holdout_v14.json",
)
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ("production_v3_20", production_detect),
        ("candidate_v3_24", detector_v3_24),
    )
