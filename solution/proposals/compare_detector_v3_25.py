"""Compare production v3.20 and proposal v3.25 through disclosed v15."""
...
from proposals.detector_v3_25 import detect as detector_v3_25
...
DISCLOSED_DATASETS = (
    ...
    *(f"sealed_holdout_v{version}.json" for version in range(4, 16)),
)
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    detectors = {"v3.20": detector_v3_20, "v3.25": detector_v3_25}
