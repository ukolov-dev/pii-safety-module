"""Compare production v3.13 and isolated v3.20 on disclosed datasets."""
...
from proposals.detector_v3_20 import detect as detector_v3_20
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    ...
    detectors: tuple[tuple[str, Detector], ...] = (
        ("production_v3_13", production_detect),
        ("candidate_v3_20", detector_v3_20),
    )
