"""Compare v3.13, v3.15, and v3.17 on disclosed datasets through v11."""
...
from proposals.detector_v3_13 import detect as detector_v3_13
from proposals.detector_v3_15 import detect as detector_v3_15
from proposals.detector_v3_17 import detect as detector_v3_17
...
def compare_all(root: Path) -> dict[str, dict[str, dict[str, int | float]]]:
    detectors = {
        "v3.13": detector_v3_13,
        "v3.15": detector_v3_15,
        "v3.17": detector_v3_17,
    }
