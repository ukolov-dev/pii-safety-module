...
EXPECTED_SHA256 = "84f4866211d26c77ee2ce78c8b5273acb5a9031565bace1c4f74117134267248"
EXPECTED_TYPES = {
    "PERSON",
    "BIRTH_DATE",
    "PLACE_OF_BIRTH",
...
def main() -> None:
    ...
    print(
        f"cases={len(cases)} clean={clean} types={len(counts)} min_type_count={min(counts.values())}"
    )
