...
| ADDRESS_HOUSE | 7 | 4 | 1 | 63.64% | 87.50% | 73.68% |
| ADDRESS_POSTAL_CODE | 1 | 0 | 3 | 100.00% | 25.00% | 40.00% |
| ADDRESS_STREET | 6 | 5 | 2 | 54.55% | 75.00% | 63.16% |
...
| DRIVER_LICENSE_RF | 1 | 0 | 1 | 100.00% | 50.00% | 66.67% |
| EMAIL | 8 | 6 | 0 | 57.14% | 100.00% | 72.73% |
...
| PERSON | 5 | 1 | 7 | 83.33% | 41.67% | 55.56% |
...
- `v10-pos-003`: missing=[('PERSON', 41, 67)]; unexpected=[]
...
- `v10-pos-008`: missing=[('PERSON', 18, 44)]; unexpected=[]
- `v10-pos-009`: missing=[('ADDRESS_CITY', 47, 53), ('ADDRESS_POSTAL_CODE', 39, 45)]; unexpected=[]
- `v10-pos-010`: missing=[('ADDRESS_COUNTRY', 44, 50), ('ADDRESS_POSTAL_CODE', 52, 58), ('ADDRESS_STREET', 85, 94)]; unexpected=[]
...
- `v10-pos-028`: missing=[('PASSPORT_RF', 35, 45)]; unexpected=[]
...
- `v10-pos-042`: missing=[('CARDHOLDER_NAME', 42, 57)]; unexpected=[]
...
- `v10-pos-050`: missing=[('DRIVER_LICENSE_RF', 44, 56)]; unexpected=[]
- `v10-pos-051`: missing=[('PLACE_OF_BIRTH', 23, 35)]; unexpected=[]
- `v10-pos-054`: missing=[('PERSON', 12, 33)]; unexpected=[('PERSON', 12, 37)]
- `v10-pos-055`: missing=[('ADDRESS_CITY', 52, 58), ('ADDRESS_POSTAL_CODE', 44, 50)]; unexpected=[]
- `v10-neg-061`: missing=[]; unexpected=[('PHONE_RF', 40, 58)]
- `v10-neg-063`: missing=[]; unexpected=[('PHONE_RF', 36, 51)]
- `v10-neg-066`: missing=[]; unexpected=[('EMAIL', 21, 43)]
- `v10-neg-067`: missing=[]; unexpected=[('ADDRESS_HOUSE', 53, 55), ('ADDRESS_STREET', 41, 47)]
- `v10-neg-078`: missing=[]; unexpected=[('PHONE_RF', 16, 32)]
- `v10-neg-081`: missing=[]; unexpected=[('PASSPORT_RF', 42, 54)]
- `v10-neg-085`: missing=[]; unexpected=[('CVV', 22, 25)]
- `v10-neg-091`: missing=[]; unexpected=[('PHONE_RF', 14, 30)]
- `v10-neg-092`: missing=[]; unexpected=[('EMAIL', 14, 35)]
...
- `v10-neg-097`: missing=[]; unexpected=[('PHONE_RF', 6, 22)]
- `v10-neg-098`: missing=[]; unexpected=[('EMAIL', 6, 32)]
- `v10-neg-099`: missing=[]; unexpected=[('ADDRESS_HOUSE', 63, 65), ('ADDRESS_STREET', 49, 57)]
- `v10-neg-100`: missing=[]; unexpected=[('CVV', 65, 68)]
- `v10-neg-101`: missing=[]; unexpected=[('EMAIL', 59, 85)]
- `v10-neg-102`: missing=[]; unexpected=[('PASSPORT_RF', 44, 68)]
